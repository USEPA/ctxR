...
- The data provided by the Functional Use Probability endpoint are
  ...
  models [(Phillips et
  al. 2017)](https://pubs.rsc.org/gc/article/19/4/1063/525082/High-throughput-screening-of-chemicals-as).
...
- HTTK data are represented by predictions from the
  ...
  particularly relevant for examining *in vitro* to *in vivo*
  extrapolation (IVIVE).
...
[(Phillips et
al. 2016)](https://pubs.rsc.org/gc/article/19/4/1063/525082/High-throughput-screening-of-chemicals-as).
