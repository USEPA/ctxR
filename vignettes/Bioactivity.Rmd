...
printFormattedTable <- function(res_dt, widen = c()) {
  datatable(res_dt, style = 'bootstrap', class = 'table-bordered table-condensed', rownames = FALSE, options = list(scrollX = TRUE, autoWidth = TRUE, dom = 't', columnDefs = list(list(width = '1250px', targets = widen))))
}
```

# Introduction

In this vignette, the [CTED Bioactivity API](https://api-ccte.epa.gov/docs/bioactivity.html) will be explored. 
...
Several ccdR functions are used to access the CTED Bioactivity API data.
