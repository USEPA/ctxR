...
```{r, echo=FALSE}
htmlTable::htmlTable(dtxsid_data,
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em')
...
```{r, echo=FALSE}
htmlTable::htmlTable(head(aeid_data),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em')
