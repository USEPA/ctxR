...
For general use of the package, the user may use the function `register_ctxR()` to store the API key in the current session or more permanently for access across sessions.
