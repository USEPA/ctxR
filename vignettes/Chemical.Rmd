...
In this vignette, [Computational Toxicology and Exposure (CTE) API Chemical endpoints](https://api-ccte.epa.gov/docs/chemical.html) will be explored. 
...
With cheminformatics as the backbone for research efforts, sources of available data through the CTE API Chemical endpoints include:
...
Several ccdR functions are used to access the CTE API Chemical data.
