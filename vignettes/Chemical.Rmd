...
In this vignette, [CTX Chemical APIs](https://api-ccte.epa.gov/docs/chemical.html) will be explored. 
...
With cheminformatics as the backbone for research efforts, sources of available data through the CTX Chemical APIs include:
