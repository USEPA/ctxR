...
This page includes two sets of information, the first of which provides a visual representation of the bioactivity data available while the second provides a summary of available genotoxicity data and associated data of the studies and sources..
...
natadb_2037
```
We do the following search to determine the assay results for chemicals in each of CCL4 and NATADB that have assay aeid 2037.
...
From this, we see that the average AC50 value for aeid 2037 Assay data for CCL4 chemicals is distributed above and below that of BPA in equal quantity, while for NATADB chemicals, all but two of 13 are higher. 
