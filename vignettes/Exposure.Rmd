...
<a href="https://cran.r-project.org/web/packages/ctxR/index.html"><img src="Pictures/ctxR_hex.png" width="200" align="right" style="float: right; margin-left: 10px; margin-bottom: 10px;"/></a>
...
```{r, echo=FALSE}
htmlTable::htmlTable(head(exp_fun_use),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
...
```{r, echo=FALSE}
htmlTable::htmlTable(head(exp_fun_use_prob),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
...
```{r, echo=FALSE}
htmlTable::htmlTable(head(exp_fun_use_cat),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
...
htmlTable::htmlTable(head(exp_prod_dat),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
...
```{r, echo=FALSE, eval=TRUE}
htmlTable::htmlTable(head(exp_prod_data_puc),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
...
```{r, echo=FALSE, eval=TRUE}
htmlTable::htmlTable(head(exp_list_tags),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
...
```{r, echo=FALSE, eval=TRUE}
htmlTable::htmlTable(head(exp_list_tags_dat),
        align = 'l',
        align.header = 'l',
        rnames = FALSE  ,
        css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ')
