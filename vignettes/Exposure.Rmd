...
In this vignette, the [CTED Exposure APIs](https://api-ccte.epa.gov/docs/exposure.html) will be explored. 
...
Several ccdR functions are used to access the CTED Exposure API data.
