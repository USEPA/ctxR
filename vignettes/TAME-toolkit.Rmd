...
vapor <- ggplot(all_vapor_grouped, aes(log_transform)) +
...
hlc <- ggplot(all_hlc_grouped, aes(log_transform)) +
  geom_boxplot(aes(color = set))
hlc
```
...
Since some of the boiling point values have negative values, we cannot log transform these values.
