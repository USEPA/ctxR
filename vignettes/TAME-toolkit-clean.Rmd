...
![Fig 1: Bisphenol A landing page](./Pictures/CCD_BPA_page.png){width=120%}
...
![Fig 2: CCD Batch Search](./Pictures/CCD_Batch_Search.png){width=120%}
...
![Fig 3: CCD Batch Search Customize Export Results](./Pictures/CCD_Batch_Search_customize_export_results.png){width=120%}
...
![Fig 4: CCTE API Chemical Endpoints](./Pictures/CCTE_Chemical_API_endpoints.png){width=120%}
...
![Fig 5: CCTE API Key Authentication](./Pictures/CCTE_API_Key_authentication.png){width=120%}
...
![Fig 6: CCTE Get Details by DTXSID](./Pictures/Get_Data_by_DTXSID_TOP.png){width=120%}
...
![Fig 7: CCTE Get Details by DTXSID data types](./Pictures/Get_Data_by_DTXSID_BOTTOM.png){width=120%}
...
![Fig 8: Bisphenol A output](./Pictures/BPA_chemicaldetailstandard.png){width=120%}
...
![Fig 9: CompTox Chemicals Dashboard Genotoxicity](./Pictures/BPA_Hazard_data_-_Genotoxicity.png){width=120%}
...
![Fig 10: CompTox Chemicals Dashboard BPA Genotoxicity](./Pictures/CCD_BPA_genotoxicity.png){width=120%}
...
![Fig 11: CCTE APIs Hazard endpoint genotoxicity resources](./Pictures/Hazard_-_genotoxicity_resource.png){width=120%}
