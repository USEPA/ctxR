...
1. What are the propertyId and propType values present in the data? What are the mean values for a specific value of the propertyID when grouped by propType and when ungrouped?

2. Are there differences between the mean predicted and experimental results for a variety of propertyIds?
...
4. How many chemicals in each data set have a 'positive', 'negative', and 'equivocal' value for the `assayResult` column?
...
*Question?* Are there differences between the mean predicted and experimental results for a variety of propertyIds? For instance, examine 'vapor-pressure', 'henrys-law', and 'boiling-point' and plot the means by chemical for these using boxplots. Compare the values by grouping by both data set and propType.
