test_that("catch missing API", {
  ...
  expect_message(get_fate_by_dtxsid(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(chemical_starts_with(word = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(chemical_equal(word = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(chemical_contains(word = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(get_msready_by_mass(start = 1, end = 2), 'Using stored API key!')
  expect_message(get_msready_by_formula(formula = 'C2H6'), 'Using stored API key!')
  expect_message(get_msready_by_formula(formula = 'C2H6'), 'Using stored API key!')
  expect_message(get_msready_by_dtxcid(DTXCID = 'DTXCID705545'), 'Using stored API key!')
  expect_message(get_chemical_lists_by_type(type = 'other'), 'Using stored API key!')
  expect_message(get_public_chemical_list_by_name(list_name = 'Biosolids2021'), 'Using stored API key!')
  expect_message(get_lists_containing_chemical(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(get_chemicals_in_list(list_name = 'Biosolids2021'), 'Using stored API key!')
  expect_message(get_all_public_chemical_lists(), 'Using stored API key!')
  expect_message(get_chemical_mrv(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(get_chemical_mol(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(get_chemical_image(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
  expect_message(get_chemical_synonym(DTXSID = 'DTXSID7020182'), 'Using stored API key!')
})
