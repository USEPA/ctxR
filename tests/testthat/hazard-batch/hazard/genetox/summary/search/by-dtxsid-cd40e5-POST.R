structure(list(url = "https://api-ccte.epa.gov/hazard/genetox/summary/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 21:30:38 GMT", `x-vcap-request-id` = "c476e975-f108-4443-407b-8a9b2bd38613", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "IzEznHrCw3ZPx2do9jzfDa04HdQMinZuMcmBtQfNNSN2NiXRtFnOzg=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.000124, starttransfer = 0.099371, 
    total = 0.0994)), class = "response")
