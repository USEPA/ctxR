structure(list(url = "https://api-ccte.epa.gov/hazard/genetox/details/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 21:30:39 GMT", `x-vcap-request-id` = "b6af53b2-1d15-4375-5d61-908c8923c5d3", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "KBAeDKSgPKe1FMKRXTpk14al20Gc45-FIhkuCzo8nS7ANK0qiB-j1w=="), class = c("insensitive", 
    ...
    date = structure(1711575039, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.4e-05, 
    connect = 0, pretransfer = 0.000178, starttransfer = 0.098765, 
    total = 0.098798)), class = "response")
