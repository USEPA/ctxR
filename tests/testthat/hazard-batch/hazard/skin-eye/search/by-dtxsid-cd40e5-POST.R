structure(list(url = "https://api-ccte.epa.gov/hazard/skin-eye/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Thu, 15 Feb 2024 20:57:21 GMT", `x-vcap-request-id` = "d28731b1-d745-4cec-4cd6-3a9f6c4dc97f", 
        ...
        `x-amz-cf-pop` = "EWR53-P1", `x-amz-cf-id` = "mPkJbyiDXzaEdzblFGXkzo5qKMyFq1MZEzrhIyihDneD5jcSlntNVA=="), class = c("insensitive", 
    ...
    date = structure(1708030641, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 3.7e-05, 
    connect = 0, pretransfer = 0.000139, starttransfer = 0.300042, 
    total = 0.300106)), class = "response")
