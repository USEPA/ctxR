structure(list(url = "https://api-ccte.epa.gov/hazard/genetox/details/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Thu, 15 Feb 2024 14:14:53 GMT", `x-vcap-request-id` = "6ae519f7-5c9a-4fc3-6e39-449c33a1601e", 
        ...
        `x-amz-cf-pop` = "EWR53-P1", `x-amz-cf-id` = "Dhn2QdF7OBmpjdnB6RNDnsBHuSJZnZxz7e-ZRsgLBDEmUdQNJrWtPA=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.00016, starttransfer = 0.092906, 
    total = 0.092964)), class = "response")
