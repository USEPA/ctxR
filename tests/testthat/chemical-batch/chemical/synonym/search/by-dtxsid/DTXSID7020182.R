structure(list(url = "https://api-ccte.epa.gov/chemical/synonym/search/by-dtxsid/DTXSID7020182", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 22 May 2024 19:50:20 GMT", `strict-transport-security` = "max-age=31536000", 
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "2d37840c-559b-458b-6148-cea76baafecf", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "Gr37mGaxfSkbLF5K5TOojZR0mYbk3EbzLQMGmJVGox7NUj360CtJ7w=="), class = c("insensitive", 
    ...
    date = structure(1716407420, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 8.2e-05, 
    connect = 0, pretransfer = 0.000237, starttransfer = 0.09698, 
    total = 0.097028)), class = "response")
