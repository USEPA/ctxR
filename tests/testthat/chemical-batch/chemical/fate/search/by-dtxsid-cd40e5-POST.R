structure(list(url = "https://api-ccte.epa.gov/chemical/fate/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "d6f15165-3c6e-4bea-63cd-be6d094581ab", 
        ...
        `x-amz-cf-pop` = "IAD89-C1", `x-amz-cf-id` = "jxjaMZ7CD_Y2YDI0C7gy4Rc7W_mf2um8VOBJwsuJuWE3mL785Hpjvw=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.000138, starttransfer = 0.129945, 
    total = 0.129979)), class = "response")
