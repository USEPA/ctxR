structure(list(url = "https://api-ccte.epa.gov/chemical/msready/search/by-dtxcid/DTXCID30182", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 17:45:18 GMT", `x-vcap-request-id` = "ef1e2a18-798d-4eb2-70f6-71b561b2e81d", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "Oj_Wx1qjsL2xrpNYTcouAtVRE0rBwGKs-MQGmzGydjw6e1CB4Vzwpg=="), class = c("insensitive", 
    ...
    date = structure(1711561518, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.4e-05, 
    connect = 0, pretransfer = 0.000156, starttransfer = 0.096596, 
    total = 0.096619)), class = "response")
