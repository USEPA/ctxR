structure(list(url = "https://api-ccte.epa.gov/chemical/msready/search/by-dtxcid/DTXCID30182", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "1f288974-02eb-45a7-6382-797e699b320f", 
        ...
        `x-amz-cf-pop` = "IAD89-C1", `x-amz-cf-id` = "bfHLTNMR3Vftwa9pB8ADjobMUe7k_tnsopGHVgZsyo3go_JNVvhcqg=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.00012, starttransfer = 0.116622, 
    total = 0.116653)), class = "response")
