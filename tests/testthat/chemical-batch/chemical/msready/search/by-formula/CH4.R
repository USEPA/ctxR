structure(list(url = "https://api-ccte.epa.gov/chemical/msready/search/by-formula/CH4", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Thu, 29 Aug 2024 19:35:53 GMT", `strict-transport-security` = "max-age=31536000", 
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "70c2334d-5732-4c35-6438-8d638fe5cb34", 
        ...
        `x-amz-cf-pop` = "IAD89-C1", `x-amz-cf-id` = "zsFhk9O7obp-PdKybl6-sR3o7IzqroCqwfPNB-PtdSgTW1mujUeKgQ=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 9.4e-05, starttransfer = 0.124114, 
    total = 0.124143)), class = "response")
