structure(list(url = "https://api-ccte.epa.gov/chemical/msready/search/by-formula/CH4", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 17:45:18 GMT", `x-vcap-request-id` = "afc8ee47-9d7c-44e8-7234-7196babffe09", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "Uva9C7VH6a_3yExZ1O7ex-AD99DSIIfg78UVWeOpqOZ40mDv4cFKAQ=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.000156, starttransfer = 0.10355, 
    total = 0.103595)), class = "response")
