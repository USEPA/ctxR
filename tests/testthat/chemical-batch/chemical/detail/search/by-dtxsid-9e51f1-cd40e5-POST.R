structure(list(url = "https://api-ccte.epa.gov/chemical/detail/search/by-dtxsid/?projection=chemicaldetailstandard", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Mon, 16 Sep 2024 17:11:06 GMT", `strict-transport-security` = "max-age=31536000", 
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "d91890cc-b92e-450b-41b9-714d9fa08f19", 
        ...
        `x-amz-cf-pop` = "IAD89-C1", `x-amz-cf-id` = "JwXXH2mGA_xWTQXOSY2d4xeNQbzg6IwM4RsDF-V5kVdZlaL90rLtRw=="), class = c("insensitive", 
    ...
    date = structure(1726506666, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 5.5e-05, 
    connect = 0, pretransfer = 0.000146, starttransfer = 0.286009, 
    total = 0.286078)), class = "response")
