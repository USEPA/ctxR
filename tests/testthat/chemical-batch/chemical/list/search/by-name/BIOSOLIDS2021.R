structure(list(url = "https://api-ccte.epa.gov/chemical/list/search/by-name/BIOSOLIDS2021", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 21:31:37 GMT", `x-vcap-request-id` = "0d1c3821-1518-4149-79be-3aa421c7e089", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "mX0YgeJ2D4PMyWyXZM8vTiCGP-y24XOt1C308lgy6YxPwJciXDNQ0A=="), class = c("insensitive", 
    ...
    date = structure(1711575097, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 5.3e-05, 
    connect = 0, pretransfer = 0.000167, starttransfer = 0.096965, 
    total = 0.096988)), class = "response")
