structure(list(url = "https://api-ccte.epa.gov/chemical/list/search/by-dtxsid/DTXSID7020182", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 17:45:21 GMT", `x-vcap-request-id` = "99fa137d-ca4d-432b-6819-420f53212f9c", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "xZwDB_NggX0U4iEgmWykYFYUNPJcV4Q3_3gAVLD3o9PxjuzUz19wIA=="), class = c("insensitive", 
    ...
    date = structure(1711561521, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4e-05, 
    connect = 0, pretransfer = 0.000195, starttransfer = 0.107362, 
    total = 0.107417)), class = "response")
