structure(list(url = "https://api-ccte.epa.gov/chemical/property/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Wed, 27 Mar 2024 21:31:27 GMT", `x-vcap-request-id` = "5b20e5a0-c2d8-4582-42fc-8a1468900153", 
        ...
        `x-amz-cf-pop` = "ATL59-P8", `x-amz-cf-id` = "AyhzngBTpQ7PfsVGzOmqdvXH0jR6ltqOVsedlNyxUeJcQEi-2dBHmg=="), class = c("insensitive", 
    ...
    connect = 0, pretransfer = 0.00016, starttransfer = 0.254462, 
    total = 0.254489)), class = "response")
