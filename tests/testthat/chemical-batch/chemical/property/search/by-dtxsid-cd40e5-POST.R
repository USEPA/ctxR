structure(list(url = "https://api-ccte.epa.gov/chemical/property/search/by-dtxsid/", 
    status_code = 401L, headers = structure(list(`content-type` = "application/json;charset=ISO-8859-1", 
        ...
        date = "Thu, 29 Aug 2024 19:35:40 GMT", `strict-transport-security` = "max-age=31536000", 
        `x-content-type-options` = "nosniff", `x-vcap-request-id` = "e8b3ee93-8e5a-4c4d-4eae-c498fd6e5659", 
        ...
        `x-amz-cf-pop` = "IAD89-C1", `x-amz-cf-id` = "2MQASLCwCAwUGGY6CGs0ono9ukyL1Z3tjkuv3OiOpe4Bjhv5XgF-mw=="), class = c("insensitive", 
    ...
    date = structure(1724960140, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.8e-05, 
    connect = 0, pretransfer = 0.00015, starttransfer = 0.117436, 
    total = 0.117469)), class = "response")
