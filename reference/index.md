...
- [`bioactivity_api_server`](https://usepa.github.io/ctxR/reference/bioactivity_api_server.md)
  : Bioactivity API Server url
- [`check_api_key()`](https://usepa.github.io/ctxR/reference/check_api_key.md)
  : Check API key
- [`check_existence_by_dtxsid()`](https://usepa.github.io/ctxR/reference/check_existence_by_dtxsid.md)
  : Check existence by DTXSID
- [`check_existence_by_dtxsid_batch()`](https://usepa.github.io/ctxR/reference/check_existence_by_dtxsid_batch.md)
  : Check existence by DTXSID batch
- [`chemical_api_server`](https://usepa.github.io/ctxR/reference/chemical_api_server.md)
  : Chemical API Server url
- [`chemical_contains()`](https://usepa.github.io/ctxR/reference/chemical_contains.md)
  : Chemical contains
- [`chemical_contains_batch()`](https://usepa.github.io/ctxR/reference/chemical_contains_batch.md)
  : Chemical contains batch search
- [`chemical_equal()`](https://usepa.github.io/ctxR/reference/chemical_equal.md)
  : Chemical equal
- [`chemical_equal_batch()`](https://usepa.github.io/ctxR/reference/chemical_equal_batch.md)
  : Chemical equal batch search
- [`chemical_starts_with()`](https://usepa.github.io/ctxR/reference/chemical_starts_with.md)
  : Chemical starts with
- [`chemical_starts_with_batch()`](https://usepa.github.io/ctxR/reference/chemical_starts_with_batch.md)
  : Chemical starts with batch search
- [`set_ctxR_option()`](https://usepa.github.io/ctxR/reference/ctxR_options.md)
  [`has_ctxR_options()`](https://usepa.github.io/ctxR/reference/ctxR_options.md)
  [`has_ctxR_option()`](https://usepa.github.io/ctxR/reference/ctxR_options.md)
  : ctxR Options
- [`exposure_api_server`](https://usepa.github.io/ctxR/reference/exposure_api_server.md)
  : Exposure API Server url
- [`get_aggregate_records_by_dtxsid()`](https://usepa.github.io/ctxR/reference/get_aggregate_records_by_dtxsid.md)
...
- [`get_aggregate_records_by_medium()`](https://usepa.github.io/ctxR/reference/get_aggregate_records_by_medium.md)
...
- [`get_all_assays()`](https://usepa.github.io/ctxR/reference/get_all_assays.md)
  : Retrieve all assays
- [`get_all_list_types()`](https://usepa.github.io/ctxR/reference/get_all_list_types.md)
  : Get all list types
- [`get_all_public_chemical_lists()`](https://usepa.github.io/ctxR/reference/get_all_public_chemical_lists.md)
...
- [`get_bioactivity_endpoint_status()`](https://usepa.github.io/ctxR/reference/get_bioactivity_endpoint_status.md)
...
- [`get_cancer_hazard()`](https://usepa.github.io/ctxR/reference/get_cancer_hazard.md)
  : Get cancer hazard
- [`get_cancer_hazard_batch()`](https://usepa.github.io/ctxR/reference/get_cancer_hazard_batch.md)
  : Get cancer hazard batch
- [`get_chem_info()`](https://usepa.github.io/ctxR/reference/get_chem_info.md)
  : Retrieve chemical information
- [`get_chem_info_batch()`](https://usepa.github.io/ctxR/reference/get_chem_info_batch.md)
  : Retrieve chemical information in batch search
- [`get_chem_props_exp()`](https://usepa.github.io/ctxR/reference/get_chem_props_exp.md)
  : Get experimental physical-chemical property data
- [`get_chem_props_exp_batch()`](https://usepa.github.io/ctxR/reference/get_chem_props_exp_batch.md)
  : Get experimental physical-chemical property data via batch
- [`get_chem_props_pred()`](https://usepa.github.io/ctxR/reference/get_chem_props_pred.md)
  : Get predicted physical-chemical property data
- [`get_chem_props_pred_batch()`](https://usepa.github.io/ctxR/reference/get_chem_props_pred_batch.md)
  : Get predicted physical-chemical property data via batch
- [`get_chem_props_summary()`](https://usepa.github.io/ctxR/reference/get_chem_props_summary.md)
  : Get Summary information on chemical properties
- [`get_chemical_by_property_range()`](https://usepa.github.io/ctxR/reference/get_chemical_by_property_range.md)
  : Get chemicals by property and its value range
- [`get_chemical_by_property_range_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_by_property_range_batch.md)
...
- [`get_chemical_details_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_details_batch.md)
  : Retrieve chemical details from DTXSID of DTXCID in batch search
- [`get_chemical_endpoint_status()`](https://usepa.github.io/ctxR/reference/get_chemical_endpoint_status.md)
  : Chemical API Endpoint status
- [`get_chemical_image()`](https://usepa.github.io/ctxR/reference/get_chemical_image.md)
  : Get image file by DTXSID or DTXCID
- [`get_chemical_image_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_image_batch.md)
  : Get image file by DTXSID or DTXCID batch
- [`get_chemical_lists_by_type()`](https://usepa.github.io/ctxR/reference/get_chemical_lists_by_type.md)
  : Get chemical lists by type
- [`get_chemical_lists_by_type_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_lists_by_type_batch.md)
  : Get chemical lists by type batch search
- [`get_chemical_mol()`](https://usepa.github.io/ctxR/reference/get_chemical_mol.md)
  : Get mol file by DTXSID or DTXCID
- [`get_chemical_mol_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_mol_batch.md)
  : Get mol file by DTXSID or DTXCID batch
- [`get_chemical_mrv()`](https://usepa.github.io/ctxR/reference/get_chemical_mrv.md)
  : Get mrv file by DTXSID or DTXCID
- [`get_chemical_mrv_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_mrv_batch.md)
  : Ger mrv file by DTXSID or DTXCID batch
- [`get_chemical_synonym()`](https://usepa.github.io/ctxR/reference/get_chemical_synonym.md)
  : Get chemical synonym
- [`get_chemical_synonym_batch()`](https://usepa.github.io/ctxR/reference/get_chemical_synonym_batch.md)
...
- [`get_chemicals_in_list_batch()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_batch.md)
  : Get chemicals in a given chemical list batch
- [`get_chemicals_in_list_contain()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_contain.md)
  : Get chemicals in a list specified by contained characters
- [`get_chemicals_in_list_contain_batch()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_contain_batch.md)
  : Get chemicals in a list specified by characters contained batch
  search
- [`get_chemicals_in_list_exact()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_exact.md)
  : Get chemicals in a list specified by exact characters
- [`get_chemicals_in_list_exact_batch()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_exact_batch.md)
  : Get chemicals in a list specified by exact characters batch search
- [`get_chemicals_in_list_start()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_start.md)
  : Get chemicals in a list specified by starting characters
- [`get_chemicals_in_list_start_batch()`](https://usepa.github.io/ctxR/reference/get_chemicals_in_list_start_batch.md)
...
- [`get_exposure_endpoint_status()`](https://usepa.github.io/ctxR/reference/get_exposure_endpoint_status.md)
...
- [`get_exposure_functional_use_category()`](https://usepa.github.io/ctxR/reference/get_exposure_functional_use_category.md)
...
- [`get_fate_by_dtxsid()`](https://usepa.github.io/ctxR/reference/get_fate_by_dtxsid.md)
  : Get fate by DTXSID
- [`get_fate_by_dtxsid_batch()`](https://usepa.github.io/ctxR/reference/get_fate_by_dtxsid_batch.md)
...
- [`get_genetox_details()`](https://usepa.github.io/ctxR/reference/get_genetox_details.md)
  : Get genetox details
...
- [`get_hazard_by_dtxsid_batch()`](https://usepa.github.io/ctxR/reference/get_hazard_by_dtxsid_batch.md)
  : Get hazard data by DTXSID batch
- [`get_hazard_endpoint_status()`](https://usepa.github.io/ctxR/reference/get_hazard_endpoint_status.md)
  : Hazard API Endpoint status
- [`get_httk_data()`](https://usepa.github.io/ctxR/reference/get_httk_data.md)
  : Get httk data
- [`get_httk_data_batch()`](https://usepa.github.io/ctxR/reference/get_httk_data_batch.md)
  : Retrieve httk data via batch search
- [`get_inchi()`](https://usepa.github.io/ctxR/reference/get_inchi.md) :
  Get InChI
- [`get_inchikey()`](https://usepa.github.io/ctxR/reference/get_inchikey.md)
  : Get InChIKey
- [`get_lists_containing_chemical()`](https://usepa.github.io/ctxR/reference/get_lists_containing_chemical.md)
  : Get chemical lists containing given chemical
- [`get_lists_containing_chemical_batch()`](https://usepa.github.io/ctxR/reference/get_lists_containing_chemical_batch.md)
...
- [`get_msready_by_dtxcid()`](https://usepa.github.io/ctxR/reference/get_msready_by_dtxcid.md)
  : Get msready by DTXCID
- [`get_msready_by_dtxcid_batch()`](https://usepa.github.io/ctxR/reference/get_msready_by_dtxcid_batch.md)
  : Get msready by DTXCID batch search
- [`get_msready_by_formula()`](https://usepa.github.io/ctxR/reference/get_msready_by_formula.md)
  : Get msready by formula
- [`get_msready_by_formula_batch()`](https://usepa.github.io/ctxR/reference/get_msready_by_formula_batch.md)
  : Get msready by formula batch search
- [`get_msready_by_mass()`](https://usepa.github.io/ctxR/reference/get_msready_by_mass.md)
  : Get msready by mass
- [`get_msready_by_mass_batch()`](https://usepa.github.io/ctxR/reference/get_msready_by_mass_batch.md)
  : Get ms ready by mass batch search
- [`get_msready_by_mass_with_error_batch()`](https://usepa.github.io/ctxR/reference/get_msready_by_mass_with_error_batch.md)
...
- [`get_public_chemical_list_by_name()`](https://usepa.github.io/ctxR/reference/get_public_chemical_list_by_name.md)
  : Get chemical list by name
- [`get_public_chemical_list_by_name_batch()`](https://usepa.github.io/ctxR/reference/get_public_chemical_list_by_name_batch.md)
...
- [`get_single_sample_records_by_dtxsid()`](https://usepa.github.io/ctxR/reference/get_single_sample_records_by_dtxsid.md)
...
- [`get_single_sample_records_by_medium()`](https://usepa.github.io/ctxR/reference/get_single_sample_records_by_medium.md)
...
- [`get_skin_eye_hazard_batch()`](https://usepa.github.io/ctxR/reference/get_skin_eye_hazard_batch.md)
  : Get skin and eye hazard batch
- [`get_smiles()`](https://usepa.github.io/ctxR/reference/get_smiles.md)
  : Get Smiles
- [`hazard_api_server`](https://usepa.github.io/ctxR/reference/hazard_api_server.md)
  : Hazard API Server url
- [`showing_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`ctxR_show_api_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`ctxR_hide_api_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`register_ctx_api_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`print(`*`<ctx_credentials>`*`)`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`ctx_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
  [`has_ctx_key()`](https://usepa.github.io/ctxR/reference/register_ctx_api_key.md)
