...
Users don't need a API key to install ctxR, but will need to supply an API key to use ctxR and access data. A *FREE* API key can be obtained by emailing the [CTX API Admins](mailto:ccte_api@epa.gov?subject=CTX%20API%20Key%20Request&body=Please%20provide%20the%20following%20information%3A%0A%0AName%3A%0AEmail%3A%0AOrganization%20(optional)%3A%0AOrg%20Type%20(optional)%3A%20(Government%7CIndustry%7CUniversity%7CResearch%7CPrivate)%0AIntended%20Use%20(optional)%3A%0A).
