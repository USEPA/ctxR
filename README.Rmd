...
The goal of ccdR is to provide R users a set of functions to access the [CTX APIs](https://api-ccte.epa.gov/docs/index.html) without requiring extensive experience interacting directly with APIs.
